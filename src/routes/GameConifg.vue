...
<script setup>
    ...
    let playerData = configInfo.Values(configInfo.data.playerData);
    let playerDataNames = configInfo.Names(configInfo.data.playerData);

    let enemyData = configInfo.Values(configInfo.data.enemyData);
    let enemyDataNames = configInfo.Names(configInfo.data.enemyData);
            ...
            <div class="half home">
                    ...
                    <ul class="inner-half">
                        <li v-for="i in playerDataNames.length">
                            ...
                            <input name="speed" v-model="playerData[i - 1]"/>
                        </li>
                    </ul>
                </div>
            <div class="half home">
